...
- <a name="E-MAC"></a>**[PML]** Proximal Mapping Loss: Understanding Loss Functions in Crowd Counting & Localization (**ICLR**) [[paper]([https://openreview.net/pdf?id=sY3anJ8C68](http://visal.cs.cityu.edu.hk/static/pubs/conf/iclr25-pml.pdf))][[code](https://github.com/Elin24/pml)]
...
- <a name="SVCW"></a>**[SVCW]** Multi-view People Detection in Large Scenes via Supervised View-wise Contribution Weighting (**AAAI**)[[paper](https://arxiv.org/abs/2405.19943)][[code](https://github.com/zqyq/Multi-view-People-Detection-in-Large-Scenes-via-Supervised-View-wise-Contribution-Weighting)]
...
- <a name="UNIC"></a>**[UNIC]** Uncertainty-aware Continuous Implicit Neural Representations for Remote Sensing Object Counting (**AISTATS**) [[paper](https://proceedings.mlr.press/v238/xu24b.html)][[code](https://github.com/SiyuanXu-tamu/UNIC)]
...
- <a name="CrowdCLIP"></a>**[CrowdCLIP]** CrowdCLIP: Unsupervised Crowd Counting via Vision-Language Model (**CVPR**)[[paper](https://arxiv.org/abs/2304.04231)][[code](https://github.com/dk-liang/CrowdCLIP)]
